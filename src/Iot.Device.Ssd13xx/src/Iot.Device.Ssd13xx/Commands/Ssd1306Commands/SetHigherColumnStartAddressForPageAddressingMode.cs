...
namespace IotDevice.Ssd13xx.Commands.Ssd1306Commands
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetHigherColumnStartAddressForPageAddressingMode" /> class.
        ...
        /// <summary>
        /// Gets higher column start address with a range of 0-15.
        /// </summary>
