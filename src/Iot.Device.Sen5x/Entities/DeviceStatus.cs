...
namespace Iot.Device.Sen5x.Entities
{
    ...
    public class DeviceStatus : AbstractReadEntity
    {
        ...
        internal override void FromSpanByte(Span<Byte> data)
        {
            ...
            this.RawDeviceStatus = BinaryPrimitives.ReadUInt32BigEndian(status);
        }

        /// <summary>
        /// Gets or sets the plain uint32 status register from the sensor.
        /// </summary>
        public uint RawDeviceStatus { get; private set; }
        ...
        /// </list>
        /// </remarks>
        public bool FanSpeedWarning => (this.RawDeviceStatus & (1 << 21)) > 0;

        /// <summary>
        /// Active during the automatic cleaning procedure of the fan.
        /// </summary>
        public bool FanCleaningActive => (this.RawDeviceStatus & (1 << 19)) > 0;

        /// <summary>
        /// Gas sensor error.
        /// </summary>
        public bool GasSensorError => (this.RawDeviceStatus & (1 << 7)) > 0;

        /// <summary>
        /// Error in internal communication with the RHT sensor.
        /// </summary>
        public bool RhtCommunicationError => (this.RawDeviceStatus & (1 << 6)) > 0;
        ...
        /// </list>
        /// </remarks>
        public bool LaserFailure => (this.RawDeviceStatus & (1 << 5)) > 0;
        ...
        /// </list>
        /// </remarks>
        public bool FanSpeedError => (this.RawDeviceStatus & (1 << 4)) > 0;
    }
}
